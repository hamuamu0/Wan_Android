 ...
 * @Describe:
 */
public class SearchResultAdapter extends BaseQuickAdapter<HomeListBean.DataBean.DatasBean, BaseViewHolder> {

    Context context;

    public SearchResultAdapter(Context context, @Nullable List<HomeListBean.DataBean.DatasBean> data) {
